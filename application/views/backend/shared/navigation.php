...
<!--								<?php if($account['permissions'][330] == 'Yes'){?><li class="nav-item"><a href="<?php echo base_url('ct-admin/approval-sellers');?>" class="nav-link<?php echo ($header_data['menuitem'] == 'sellerapproval')? ' active':'';?>"><span>Property Owners</span><?php echo (($waiting_approvals['Seller'])? '<span class="badge badge-danger align-self-center ml-auto">'.$waiting_approvals['Seller'].'</span>':'');?></a></li><?php } ?>-->
						...
						<li class="nav-item nav-item-submenu<?php echo ($header_data['menusection'] == 'tutorials')? ' nav-item-open':'';?>">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Tutorial Pages" <?php echo ($header_data['menusection'] == 'tutorials')? 'style="display: block;"':'';?>>
								...
								<?php if($account['permissions'][550] == 'Yes'){?><li class="nav-item"><a href="<?php echo base_url('ct-admin/tutorial-video');?>" class="nav-link<?php echo ($header_data['menuitem'] == 'agentvideo')? ' active':'';?>">Introduction Video</a></li><?php } ?>
							</ul>
						</li>
						...
						<li class="nav-item"><a href="<?php echo base_url('ct-admin/specializations');?>" class="nav-link<?php echo ($header_data['menuitem'] == 'specializations')? ' active':'';?>"><i class="icon-list"></i> <span>Specializations</span></a></li>

						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-address-book"></i><span>Memberships</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Location">
								<li class="nav-item"><a href="<?php echo base_url('ct-admin/memberships');?>" class="nav-link<?php echo ($header_data['menuitem'] == 'memberships')? ' active':'';?>"><span>Plans</span></a></li>
								<li class="nav-item"><a href="<?php echo base_url('ct-admin/features');?>" class="nav-link<?php echo ($header_data['menuitem'] == 'features')? ' active':'';?>"><span>Features</span></a></li>
							</ul>
						</li>
