	  ...
	  <div class="card-body">
		  <?php if($messages){ ?>
			  <?php  foreach ($messages as $message) { ?>
			  	<a href="<?php echo cortiam_base_url('view-messages/').$message['agent_id'].'-'.url_title( trim( preg_replace( "/[^0-9a-z]+/i", " ",  $message['first_name'].' '.$message['last_name'])), 'underscore', true);?>" class="row no-gutters messagelistitem">
			  		<div class="col-md-9 msgtitle"><strong><?php echo $message['first_name'].' '.$message['last_name'];?></strong></div>
