				...
				if ($messages) {
					foreach ($messages as $message) {
						...
						echo '<li class="media media-chat-item-reverse">
										...
										<div class="ml-3">
												<img src="'.(($message['seller_image'])? base_url(str_replace(".jpg","_mini.jpg",$message['seller_image'])):base_url('images/userphoto_mini.jpg')).'" class="rounded-circle" width="40" height="40" alt="You">
										</div>
									</li>';
						}else{
							echo '<li class="media">
